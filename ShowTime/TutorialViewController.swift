...
class TutorialViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [Slide]
    {
        ...
        slide5.labelDesc.text = "There will be different levels to test your teams' Showtime moves, so challenge yourself! Up your level once you find one music is too east peasy lemon squeezy "
